...
from src.features.structures import genre_features_map, weekday_no_map
...
for document in cursor:
	...
	IMDb_Rating = int(IMDb_Rating_value)
...
print (data_frame)
data_frame.to_csv("../../data/10_class_rating_dataset.csv", sep='\t')
